...
const Header = () => {
  ...
  return (
    <div className={`bg-[url('/src/assets/bg.svg')] bg-no- w-full flex items-center py-28`}>
      <div className='mx-auto  w-full text-white flex flex-col justify-center text-center items-center'>
        <h1 className='font-bold md:text-4xl text-2xl md:w-full w-3/4 '>
          Download High Quality Images by creators
        </h1>
        <h2 className='font-medium md:text-sm text-xs md:w-full w-2/3 text-[#C4C4C4] my-3'>
